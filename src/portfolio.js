      ...
      experiences: [
        {
          ...
          description: [
            "Owned end-to-end product lifecycle for a GenAI compliance-testing platform across the Reveal and Fuse systems, shipping the first production version of a requirements-to-data translation layer within the first 5 months of tenure",
            "Drove AI adoption strategy across compliance, legal, and advisory stakeholders by defining data-attribute specs and metadata standards, replacing 40+ hours/month of manual reconciliation with a single traceable schema over Q2 2026",
            ...
            "Prioritized a cross-platform product roadmap by mapping data synchronization gaps across 2 systems of record, sequencing fixes that eliminated redundant manual entry across the Reveal and Fuse platforms over Q2 2026",
        ...
        },
        {
          ...
          description: [
            ...
            "Authored 10+ SRS/FRD documents codifying payment-processing logic and PCI compliance requirements, standing up the shared spec layer between engineering and operations teams over a 6-month rollout.",
            "Built Power BI dashboards visualizing operational bottlenecks across 5 business units, surfacing process gaps that cut merchant onboarding time from an est. baseline ~10 days to ~6 days per merchant by Q4 2022",
            "Partnered with engineering and finance stakeholders across a 3+ year tenure to translate ambiguous business needs into shippable requirements, establishing the analytics-to-requirements pipeline that scaled the platform's reporting stack from intern-era ad-hoc reports to a governed BI layer by 2023",
          ],
          color: "#000000",
        },
      ],
...
const aiProductsHeader = {
  ...
  description:
    "AI products leveraging LLMs, RAG systems, and agentic workflows. FinSense: AI-powered financial decisioning with risk classification and NLP query resolution. PRD.ai: Instant PRD generation from simple prompts. Additional concepts demonstrating translating advanced AI (LangChain, CrewAI, vector databases) into scalable B2B SaaS solutions with measurable enterprise impact.",
  avatar_image_path: "projects_image.svg",
};
